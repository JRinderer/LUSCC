...
typedef enum{
    //reserved words
    IF,ELSE, INT, RETURN, VOID, WHILE, OUTPUT, INPUT,
    //symbols
    PLUS,MINUS,TIMES,DIVIDE,LPAREN,RPAREN,LBRACKET,RBRACKET,LCURLY,RCURLY,SEMICOL,ASSIGN,EQL,NTEQL,COMMA, LNCMT,STCMT,ENCMT,NONE_T,IGN
}token_types;
